...
public class ChatController {
    ...
    public ChatController(ChatModel chatModel, CommonTool commonTool) {
        ...
        List<ToolCallback> tools = List.of(provider.getToolCallbacks());
    ...
    public String rag(@RequestBody String question) {
        PromptTemplate domainTemplate = PromptTemplate.builder().template("""
                ...
                Answer:
                """).build();
        Prompt prompt = domainTemplate.create(Map.of("question", question));
